...
<div class="mx-auto max-w-4xl text-[15px] leading-relaxed">
    ...
    <p class="mb-4 text-justify indent-10">
        ...
        <?php echo e(optional($exam->scheduled_at)->locale('id')->translatedFormat('l, d F Y') ?? '.................... 2026'); ?>,
    ...
    <div class="mt-16 flex justify-end">
        <div class="w-72 text-left">
            ...
            <p class="font-bold underline">Ir. Marsujitullah, S.Kom., M.T</p>
            <p>NIP. 198905272019031013</p>
        </div>
    </div>
            ...
            <tbody>
                <tr>
                    <td class="border border-black p-2 text-center">
                        <?php echo e(optional($exam->scheduled_at)->locale('id')->translatedFormat('l')); ?><br>
                        <?php echo e(optional($exam->scheduled_at)->locale('id')->translatedFormat('d F Y')); ?>

                    </td>
                    <td class="border border-black p-2 text-center">1</td>
                    <td class="border border-black p-2 text-center">
                        <?php echo e(optional($exam->scheduled_at)->format('H:i')); ?>
                    ...
                    <td class="border border-black p-2">
                        <?php echo e($exam->title->title ?? '-'); ?>

                    </td>
                    <td class="border border-black p-2">
                        1. <?php echo e($exam->title->supervisor->name ?? '-'); ?><br>
                        2. <?php echo e($exam->title->supervisor2->name ?? '-'); ?>
...
</html><?php /**PATH D:\VITRA\SIM-SKRIPSI\vitra-skripsi-laravel-fixed\resources\views/exams/schedule-letter.blade.php ENDPATH**/ ?>