...
<div class="mx-auto max-w-3xl text-[15px] leading-relaxed">
    ...
    <table class="mb-5 w-full">
        <tr>
            ...
            <td class="py-1">
                <?php echo e($title->supervisor->name ?? '-'); ?> : Sebagai Pembimbing 1
            </td>
        </tr>
        <tr>
            <td class="py-1">2.</td>
...
</html><?php /**PATH D:\VITRA\SIM-SKRIPSI\vitra-skripsi-laravel-fixed\resources\views/titles/approval-letter.blade.php ENDPATH**/ ?>