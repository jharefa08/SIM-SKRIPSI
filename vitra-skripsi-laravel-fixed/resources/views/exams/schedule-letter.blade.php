...
<div class="mx-auto max-w-4xl text-[15px] leading-relaxed">
    ...
    <p class="mb-4 text-justify indent-10">
        ...
        {{ optional($exam->scheduled_at)->locale('id')->translatedFormat('l, d F Y') ?? '.................... 2026' }},
            ...
            <tbody>
                <tr>
                    <td class="border border-black p-2 text-center">
                        {{ optional($exam->scheduled_at)->locale('id')->translatedFormat('l') }}<br>
                        {{ optional($exam->scheduled_at)->locale('id')->translatedFormat('d F Y') }}
                    </td>
                    <td class="border border-black p-2 text-center">1</td>
                    <td class="border border-black p-2 text-center">
                        {{ optional($exam->scheduled_at)->format('H:i') }}
                    </td>
                    ...
                    <td class="border border-black p-2">
                        1. {{ $exam->title->supervisor->name ?? '-' }}<br>
                        2. {{ $exam->title->supervisor2->name ?? '-' }}
                    </td>
                    <td class="border border-black p-2">
